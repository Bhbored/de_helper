...
class _SubcategoryPageState extends ConsumerState<SubcategoryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return PageScaffold(
      ...
      onAction: _isSelectionMode ? null : showAddSubcategoryBottomSheet,
                        ...
                        : Builder(
                            builder: (context) {
                              final allSubcategories =
                                  displayedSubcategories.value!;
                              final paginatedSubcategories = allSubcategories
                              ...
                              return SliverPadding(
                                ...
                                sliver: SliverList(
                                  ...
                                  }, childCount: paginatedSubcategories.length),
                                ),
                              );
                            },
                          ),
                    if (displayedSubcategories.value != null &&
                        displayedSubcategories.value!.isNotEmpty)
                      SliverToBoxAdapter(
                        child: Builder(
                          builder: (context) {
                            final allSubcategories =
                                displayedSubcategories.value!;
                            final totalPages =
                                (allSubcategories.length / _itemsPerPage)
                                    .ceil();
